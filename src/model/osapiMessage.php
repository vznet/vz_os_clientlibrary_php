...
class osapiMessage {
  ...
  public function __construct($recipients, $initBody, $initTitle, $initType = 'PRIVATE_MESSAGE') {
    if (!is_array($recipients)) {
      throw new osapiException("recipients should be an array with user id's");
    }
